...
namespace Project.UI.Areas.CustomerPanel.Controllers
{
    ...
    public class TicketController : Controller
    {
        ...
        public IActionResult customerGeneratePDF(List<string> checkboxes, [FromServices] IToastNotification toast)
        {
...
<footer>
    ...
    <span>
      Adres
        ...
        public IActionResult customerDeleteAsBatch(List<string> checkboxes, [FromServices] IToastNotification toast)
        {
            if (checkboxes != null && checkboxes.Any())
            {
                foreach (var id in checkboxes)
